...
import com.huyuxuan.student_server.entity.SCTInfo;
import com.huyuxuan.student_server.entity.StudentCourseTeacher;
...
public interface StudentCourseTeacherMapper {
    ...
    List<SCTInfo> findBySearch(@Param("sid") Integer sid,
